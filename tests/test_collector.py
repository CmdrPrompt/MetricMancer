...
from src.app.collector import collect_results
...
class TestCollector(unittest.TestCase):
    ...
    @patch('src.app.collector.os.path.isdir')
    ...
    @patch('src.app.collector.os.path.isdir')
    @patch('src.app.collector.os.walk')
    @patch('src.app.collector.FileAnalyzer')
    ...
    @patch('src.app.collector.os.walk')
    @patch('src.app.collector.FileAnalyzer')
    @patch('src.app.collector.os.environ', {'THRESHOLD_LOW': '5', 'THRESHOLD_HIGH': '10'})
