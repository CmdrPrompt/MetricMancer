...
**Document Version:** 3.3.0 (Updated: 2025-12-12) **MetricMancer Version:** 3.3.0 **Status:** Release - Refactoring
and Code Quality
...
| FR1.1       | tests/kpis/test_cognitive_complexity_python.py, tests/kpis/test_cognitive_complexity_java.py, tests/kpis/test_cognitive_complexity_go.py, tests/kpis/test_cognitive_complexity_javascript.py, tests/kpis/test_cognitive_complexity_typescript.py, tests/kpis/test_cognitive_complexity_c.py, tests/kpis/test_cognitive_complexity_factory.py (135+ cognitive complexity tests across 6 languages)                                                                                                                                                                                                                                                                                                                                           | Implemented v3.2.0                                     |
| FR2         | tests/app/test_churn_detection.py:test_churn_detected, tests/app/test_churn_kpi_path_mismatch.py:test_churn_lookup_with_absolute_path, test_churn_lookup_with_relative_path_should_match_absolute, tests/utilities/test_git_cache.py:test_calculate_churn_custom_period, tests/kpis/test_churn_time_based_fix.py:test_different_time_periods_should_be_configurable                                                                                                                                                                                                   | Implemented - Time-based via git log --since           |
| FR2.1       | tests/kpis/test_churn_time_based_fix.py:test_churn_period_90_days, test_churn_period_180_days, test_churn_period_365_days, tests/utilities/test_git_cache.py:test_calculate_churn_custom_period                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Implemented - --churn-period CLI flag                  |
...
| FR3.1       | tests/kpis/test_cognitive_hotspot_kpi.py:test_cognitive_hotspot_calculation, test_cognitive_hotspot_with_zero_churn, test_cognitive_hotspot_with_zero_complexity, test_cognitive_hotspot_edge_cases                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Implemented v3.2.0                                     |
